                ...
                >
                    ...
                    <Box flex="1" maxW={'100%'} overflowX={'hidden'}>
                        ...
                        <Table style={{fontSize: "sm"}}>
                            <Tbody>
                                <Tr>
                                    <Td p={[1, 2]}><Text fontSize={['xs', 'sm']}>Company
                                        address</Text></Td>
                                    <Td p={[1, 2]}><Text fontSize={['xs', 'sm']}>Personal
                                        address</Text></Td>
                                    <Td p={[1, 2]}><Text fontSize={['xs', 'sm']}>NI
                                        number</Text></Td>
                                </Tr>
                                <Tr>
                                    <Td p={[1, 2]}><Text fontSize={['xs', 'sm']}>Date of
                                        birth</Text></Td>
                                    <Td p={[1, 2]}><Text fontSize={['xs', 'sm']}>Bank account
                                        information</Text></Td>
                                    <Td p={[1, 2]}><Text fontSize={['xs', 'sm']}>Personal/sales
                                        invoices</Text></Td>
                                </Tr>
                                <Tr>
                                    <Td p={[1, 2]}><Text fontSize={['xs', 'sm']}>Copies of
                                        ID</Text></Td>
                                    <Td p={[1, 2]}><Text fontSize={['xs', 'sm']}>Contact
                                        number</Text></Td>
                                    <Td p={[1, 2]}><Text
                                        fontSize={['xs', 'sm']}>Website</Text></Td>
                                </Tr>
                                <Tr>
                                    <Td p={[1, 2]}><Text fontSize={['xs', 'sm']}>Email
                                        address</Text></Td>
                                    <Td p={[1, 2]}><Text fontSize={['xs', 'sm']}>Job
                                        titles</Text></Td>
                                    <Td p={[1, 2]}><Text fontSize={['xs', 'sm']}>Salary
                                        details</Text></Td>
                                </Tr>
                                <Tr>
                                    <Td p={[1, 2]}><Text fontSize={['xs', 'sm']}>Student loan
                                        information</Text></Td>
                                    <Td p={[1, 2]}><Text fontSize={['xs', 'sm']}>Gender</Text></Td>
                                    <Td p={[1, 2]}><Text fontSize={['xs', 'sm']}>Marital
                                        status</Text></Td>
                                </Tr>
                                <Tr>
                                    <Td p={[1, 2]}><Text
                                        fontSize={['xs', 'sm']}>Nationality</Text></Td>
                                    <Td p={[1, 2]}><Text fontSize={['xs', 'sm']}>Criminal record
                                        information</Text></Td>
                                    <Td p={[1, 2]}><Text fontSize={['xs', 'sm']}>Personal Assets and
                                        liabilities</Text></Td>
                                </Tr>
                            </Tbody>
                        </Table>
                        ...
                        <UnorderedList pl={5} mb={4}>
                            <ListItem fontSize={["sm", "md"]}>Receiving calls from you in relation to any services
                                within your
                                business.</ListItem>
                            <ListItem fontSize={["sm", "md"]}>Conducting any relevant service for your
                                business.</ListItem>
                            <ListItem fontSize={["sm", "md"]}>Team members contacting you by means of business
                                development activity.</ListItem>
                            <ListItem fontSize={["sm", "md"]}>Attending business networking events with
                                clients.</ListItem>
                            <ListItem fontSize={["sm", "md"]}>When you have been identified as a reference
                                provider.</ListItem>
                        </UnorderedList>
                        ...
                        <UnorderedList pl={5} mb={4}>
                            <ListItem fontSize={["sm", "md"]}>HMRC records – 6 years</ListItem>
                            <ListItem fontSize={["sm", "md"]}>Payroll information – 7 years</ListItem>
                            <ListItem fontSize={["sm", "md"]}>Accounts information – 7 years</ListItem>
                            <ListItem fontSize={["sm", "md"]}>Pension transfer – 7 years</ListItem>
                        ...
                        <UnorderedList pl={5} mb={4}>
                            <ListItem fontSize={["sm", "md"]}>The data is no longer necessary for the reason it was
                            ...
                            <ListItem fontSize={["sm", "md"]}>The data has been processed unlawfully (in breach of
                                GDPR).</ListItem>
                            <ListItem fontSize={["sm", "md"]}>Data must be erased to comply with a legal
                                obligation.</ListItem>
                        </UnorderedList>
                        <Text fontSize={["sm", "md"]} mb={4}>
                        ...
                        <UnorderedList pl={5} mb={4}>
                            ...
                            <ListItem fontSize={["sm", "md"]}>In the defence of a claim.</ListItem>
                        </UnorderedList>
                        ...
                        <UnorderedList pl={5} mb={4}>
                            <ListItem fontSize={["sm", "md"]}>You do not agree with the accuracy of your personal
                                data.</ListItem>
                            <ListItem fontSize={["sm", "md"]}>The data has been unlawfully processed.</ListItem>
                            <ListItem fontSize={["sm", "md"]}>To establish or defend a legal claim.</ListItem>
                            <ListItem fontSize={["sm", "md"]}>You object to our legal ground for processing your
                                data.</ListItem>
                        </UnorderedList>
                        <Text fontSize={["sm", "md"]} mb={4}>
                        ...
                        <UnorderedList pl={5} mb={4}>
                            ...
                            <ListItem fontSize={["sm", "md"]}>Processing for scientific/historical research or
                                statistical purposes.</ListItem>
                        </UnorderedList>
                        <Text fontSize={["sm", "md"]} mb={4}>
