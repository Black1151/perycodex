...
export default function SideBars() {
    ...
    const generateLeftSidebarItemsDrawer = (userRole: string | undefined) => {
        ...
        return items.map(({url, ...item}) => ({
            ...
            active: url === pathname + (searchParams.toString() ? `?${searchParams.toString()}` : ""),
        }));
    };
    ...
    const generateRightSidebarItemsDrawer = useMemo(() => {
        ...
        return shouldShowManageTags
            ...
            : [];
    }, [pathname, user?.role, user?.userId, user?.customerId, recordId, recordCustomerId, recordParentId]);
