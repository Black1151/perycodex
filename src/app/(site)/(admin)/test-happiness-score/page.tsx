...
import CreateComponent from "@/app/(site)/(admin)/test-happiness-score/CreateComponent";
import { Box, Flex, Grid, Text } from "@chakra-ui/react";
import DashboardLayout from "@/app/(site)/(admin)/test-happiness-score/DashboardLayout";
    ...
    <>
      ...
      <Box py={3} borderRadius="lg">
        ...
        >
          ...
          <Text fontSize="sm">
            This could be a line chart or a bar graph about user happiness.
          </Text>
        </Box>
        ...
        >
          ...
          <Text fontSize="sm">
            This could be a table showing the details of the happiness score by
            user.
          </Text>
        </Box>
      </Box>
