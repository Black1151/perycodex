...
const InviteNewUserLimitReached = ({
  isOpen,
  onClose,
      ...
      <ModalContent>
        ...
        <ModalBody>
          <Text textAlign={"center"} fontSize={"base"} paddingBottom={4}>
            You have reached the maximum number of users allowed for your account. Please contact support to increase your user limit.
          </Text>
        </ModalBody>
      </ModalContent>
    </Modal>
...
export default InviteNewUserLimitReached;
