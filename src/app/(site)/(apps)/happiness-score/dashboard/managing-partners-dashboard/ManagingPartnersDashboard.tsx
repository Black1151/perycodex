...
const ManagingPartnersDashboard: React.FC = () => {
  ...
  // Current Week Leaderboard Bar Chart
  ...
  return (
    <VStack align="stretch" spacing={6} w="full" p={4}>
      ...
      {/* Row with "Average" and "Scores and Comments" */}
      <Flex w="100%" gap={6}>
        {/* Average */}
        <Box w="50%" textAlign="center" borderRadius="lg">
          <Flex
            width="100%"
          ...
          <Heading color="white">
            {parseInt(totalAvg as unknown as string, 10)}
          </Heading>
        </Box>
