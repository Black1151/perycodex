...
import { Box, Heading, Text, Link, Stack, HStack, Code } from "@chakra-ui/react";
...
const ContactSales: React.FC<ContactSalesProps> = ({ subscriptionId }) => (
    ...
    >
        ...
        <Text mb="4">
            To change your billing cycle, adjust an annual subscription or any other sales inquiries, please contact us using the information below.
        </Text>
