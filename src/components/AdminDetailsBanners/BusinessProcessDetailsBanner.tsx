        ...
        <Flex mb={4} p={4} color={'white'} overflow={'hidden'}>
            ...
            <FormControl w={'100px'} h={'100px'} aspectRatio={1} borderRadius={'full'}>
                <Box
                    ...
                    alignItems="center"
                >
                    <SchemaIcon fontSize="large" sx={{color: "var(--chakra-colors-perygonPink)"}}/>
                </Box>
            </FormControl>
            ...
            <VStack align="start" ml={4} spacing={3}>
                <Flex alignItems="center" gap={2}>
                    ...
                    />
                    <Heading fontWeight={300} size={['md', 'md', 'lg']}>{businessProcess.name}</Heading>
                </Flex>
            </VStack>
            {/* Metadata Information */}
            <VStack ml="auto" alignItems="end" justifyContent="flex-start" display={['none', 'none', 'flex']}>
                <Heading size={['md', 'md', 'lg']} fontWeight={100}>ID: {businessProcess.id}</Heading>
