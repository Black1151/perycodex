...
import {Box, VStack, HStack, Heading, useTheme, Center, Spinner, Fade} from "@chakra-ui/react";
import {ChevronLeft, ChevronRight, Close, Menu, SvgIconComponent} from "@mui/icons-material";
import useDrawerState, {DrawerStateOptions} from "@/components/Sidebars/useDrawerState";
