...
const SubmissionsTooltipRenderer = (params: AgCartesianSeriesTooltipRendererParams): string => {
    ...
    <div class="ag-chart-tooltip" style="border: 1px solid ${color}; border-radius: 8px;">
      ...
      <div class="ag-chart-tooltip-content" style="border: 1px solid white; border-radius: 0 0 8px 8px;">
        <span>Submissions: ${yValue}</span><br />
      </div>
    </div>
  `;
};

export default SubmissionsTooltipRenderer;
