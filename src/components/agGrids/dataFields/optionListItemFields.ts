...
export const optionListItemsFields: ColDef[] | any = [
    ...
    {headerName: "Option List ID", field: "optionListId", sortable: true, filter: true},
    {headerName: "Value 1", field: "value1", sortable: true, filter: true},
    {headerName: "Value 2", field: "value2", sortable: true, filter: true},
    {headerName: "Value 3", field: "value3", sortable: true, filter: true},
