...
export type NewCustomerUserProfileCompletionFormInputs = {
  titleId: string;
  firstName: string;
  lastName: string;
  mobile: string;
...
interface NewCustomerUserProfileCompletionFormProps {
...
export function NewCompanyUserProfileCompletionForm({
  isSubmitting,
  dropdowns,
}: NewCustomerUserProfileCompletionFormProps) {
