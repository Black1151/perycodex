      ...
      elements: [
        {
          ...
          isRequired: true,
          valuePropertyName: "id", // store the tool.id
          hideNumber: true,
          ...
          choicesByUrl: {
            ...
            path: "resource",
            valueName: "id", // the field to save as the choice value
            titleName: "displayName", // the field to show as the main label

            // ── These two lines tell SurveyJS which fields carry image & description:
            imageLinkName: "logoImageUrl", // field with your image URL :contentReference[oaicite:0]{index=0}
            descriptionName: "previewText", // field with your description text
          },

          // ── Tell the question to render those images & descriptions:
          showImage: true, // render the imageLinkName under the checkbox :contentReference[oaicite:1]{index=1}
          showDescription: true, // render the descriptionName under the label
        },
      ],
    },
  ],
