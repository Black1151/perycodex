...
export const darkSurveyTheme = {
    isPanelless: true,
    cssVariables: {
        ...baseSurveyCssVariablesTheme,
        // Background of SurveyJS colors
        "--sjs-general-backcolor": "#1A202C00", // Unsure what this one is doing
        "--sjs-general-backcolor-dark": "#2D374800", // Unsure what this one is doing
        "--sjs-general-backcolor-dim": "#1A202C00", // Background of SurveyJS if no image
        "--sjs-general-backcolor-dim-light": "#2D374800", // Unsure what this one is doing
        "--sjs-general-backcolor-dim-dark": "#2D374800", // Unsure what this one is doing

        // Unsure for this Forecolor
        "--sjs-general-forecolor": "#FFFFFF",
        "--sjs-general-forecolor-light": "#000000FF", // Opacity?
        ...
        // Borders
        "--sjs-border-default": "#B6203B",
        "--sjs-border-light": "#B6203B",
        "--sjs-border-inside": "#B6203B",

        //
        "--sjs-question-background": "#a2ffc600", // Unsure what this one does

        // Page Title
        "--sjs-font-pagetitle-color": "rgba(255, 255, 255, 1)",

        // Panels
        "--sjs-questionpanel-backcolor": "#696969",
        "--sjs-questionpanel-hovercolor": "rgba(255, 255, 255, 0.15)",

        // Question Titles
        "--sjs-font-questiontitle-color": "#E5E5E5",
        ...
        // Editor Panel - This looks like the background of a field
        "--sjs-editor-background": "#191919", // Background of the question input field

        "--sjs-editorpanel-hovercolor": "#B6203BCC", // Hover over boolean switch

        // Font Editor
        "--sjs-font-editorfont-color": "#191919",
        "--sjs-font-editorfont-placeholdercolor": "var(--chakra-colors-gray-400)",
